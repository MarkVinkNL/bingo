...
<div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10">
  <div class="p-6">
    ...
    <div class="inline-grid w-full max-w-2xl border-4 border-gray-300 dark:border-gray-600"
      ...
      @foreach ($cells as $cell)
        ...
        @endphp
        <div
          class="cell flex min-h-0 items-center justify-center border-r-4 border-b-4 border-gray-300 p-2 text-center text-sm font-medium dark:border-gray-600 {{ $isLastCol ? 'border-r-0' : '' }} {{ $isLastRow ? 'border-b-0' : '' }} {{ $cell->is_marked
