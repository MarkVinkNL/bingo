<x-layouts::auth>
  <div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-3">
      <flux:link :href="route('auth.socialite.redirect', ['provider' => 'google'])" variant="outline"
        class="w-full justify-center">
        {{ __('Continue with Google') }}
      </flux:link>
      <flux:link :href="route('auth.socialite.redirect', ['provider' => 'github'])" variant="outline"
        class="w-full justify-center">
