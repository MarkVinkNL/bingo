...
new class extends Component {
    ...
    public function updateProfileInformation(): void
    {
        ...
        $rules = $user->usesOAuth() ? ['name' => $this->nameRules()] : $this->profileRules($user->id);
    ...
    public function resendVerificationNotification(): void
    {
        ...
        if ($user->hasVerifiedEmail()) {
            $this->redirectIntended(default: route('bingo.index', absolute: false));
      ...
      <div>
        @if (auth()->user()->usesOAuth())
          <flux:field>
            ...
            <flux:description>
              {{ __('Your email is managed by your :provider account.', ['provider' => ucfirst(auth()->user()->oauth_provider)]) }}
            </flux:description>
          </flux:field>
        @else
